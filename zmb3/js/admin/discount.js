...
function pageitem(e){
   $('.favorable_list').empty();
	...
	for(var np=(pagenub*(e-1));np<overpage;np++){
	    $('.favorable_list').append('<div class="list"><div class="pic_first"><img src="'+pagjson[np].zt+'" class="adaimg"/></div><ul><li class="title">'+pagjson[np].zbt+'</li><li class="content">'+pagjson[np].fbt+'</li><li class="more"><a href="discountxq.html?id='+pagjson[np].yhid+'">'+jstag("xmltext64")+'></a></li></ul></div>');
	}
}
